...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DatabaseReference imgeRef = FirebaseDatabase.getInstance().getReference().child("Users").child(auth.getUid()).child("image");

        DatabaseReference imgeRef = FirebaseDatabase.getInstance().getReference()
                .child("Users").child(auth.getUid());
               imgeRef .addValueEventListener(new ValueEventListener() {
...
//Log.e(TAG,"url imge is : "+Prevelant.currentOnlineUser.getProfileImg());
        recyclerView = findViewById(R.id.recycl_menu);
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder
                            (@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
